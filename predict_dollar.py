...
plt.plot(y_test.values, color="blue", linewidth=2, label="Real Price")
plt.plot(y_pred_lr, color="red", linewidth=2, label="predicted Price")
plt.legend()
plt.tight_layout()
plt.xlabel("Day")
plt.ylabel("Dollar Price")
plt.grid(True)
plt.savefig('prediction_plot.png', dpi=300, bbox_inches='tight', facecolor='white')
plt.close()
